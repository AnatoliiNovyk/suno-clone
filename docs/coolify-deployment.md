...
1. Створіть ресурс **Docker Compose** з цього Git-репозиторію.
...
| `CORS_ORIGINS` | точний origin, наприклад `https://music.example.com` |
...
2. У Supabase Auth додайте `https://music.example.com` до Site URL і Redirect
   URLs.
3. Задайте `SITE_URL=https://music.example.com` та секрети провайдерів у
...
2. Відкрийте `https://music.example.com/` і перевірте, що SPA-роути
