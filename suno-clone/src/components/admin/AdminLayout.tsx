...
const sections = [
  ...
  { to: '/admin/pricing', label: 'Тарифи', icon: CreditCard, end: false, ready: true },
  { to: '/admin/subscriptions', label: 'Підписки', icon: Receipt, end: false, ready: true },
  { to: '/admin/audit', label: 'Аудит', icon: ScrollText, end: false, ready: true },
];
